...
pub fn ButtonPage() -> Element {
    ...
    rsx! {
            div { class: "w-full min-h-screen p-4 sm:p-6 md:p-8 flex flex-col items-center bg-gray-50",
                div { class: "w-full max-w-4xl flex flex-col gap-6 md:gap-8",
                    ...
                    div { class: "flex flex-col items-center gap-4 text-center",
                        ...
                        p { class: "text-gray-600 max-w-md md:max-w-lg text-sm sm:text-base",
                            {t!("freyr_button_text")}
                        }
                    }
                    ...
                    div { class: "w-full flex flex-col gap-8 md:gap-10",
                        ...
                        div { class: "flex flex-col items-center gap-4 p-6 bg-white rounded-xl shadow-sm",
                            ...
                            div { class: "w-full mt-4",
                                p { class: "text-gray-500 text-sm mb-2", "Implementation in code:" }
                                CodeBlock {
                                    code: r#"BasicButton {
    color: ButtonColor::Freyr,
    label: "Go to Home",
        ...
        url: "/".to_string()
                        ...
                        div { class: "flex flex-col items-center gap-4 p-6 bg-white rounded-xl shadow-sm",
                            ...
                            div { class: "flex flex-col items-center gap-3",
                                ...
                                div { class: "text-gray-700 font-medium", "Count: {count}" }
                            }
                           div { class: "w-full mt-4",
        CodeBlock {
